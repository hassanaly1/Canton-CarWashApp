...
class WorkWashPlanScreen extends StatefulWidget {
  const WorkWashPlanScreen({super.key});

  @override
  State<WorkWashPlanScreen> createState() => _WorkWashPlanScreenState();
}

class _WorkWashPlanScreenState extends State<WorkWashPlanScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: whiteCustomAppBar(title: 'Work Wash Monthly Plan'),
